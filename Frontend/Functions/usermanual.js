    ...
    return [
        ...
        },
        {
            ...
            slides: [
                ...
                { t: 'Step 3: Fill in the details', h: '<p>Enter the <b>destination</b>, the <b>Date of Gate Pass</b> (which day the pass is for), the time, and the <b>purpose</b>. If a company vehicle is needed, select the <b>trip type</b>. In the Associates section, leave the list empty if you are going out alone. Otherwise add everyone who is going out — including yourself, if you are going with them. If your name is not on the list, the pass covers the listed companions only. Set each row to <b>Employee</b> to pick from the employee directory, or <b>Non-employee</b> to type the name of a visitor or an OJT. Pressing Enter on a finished row adds the next companion row.</p>' + umImg('r3-request-form', 'Request form filled in') },
